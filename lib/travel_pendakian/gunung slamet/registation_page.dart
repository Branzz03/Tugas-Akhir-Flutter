...
class TravelFormRegistrationPageslamet extends StatefulWidget {
  const TravelFormRegistrationPageslamet({super.key});

  @override
  _TravelFormRegistrationPageslametState createState() =>
      _TravelFormRegistrationPageslametState();
}

class _TravelFormRegistrationPageslametState
    extends State<TravelFormRegistrationPageslamet> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Kabupaten Pemalang, Brebes, Tegal, Banyumas.',
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'Gunung Slamet merupakan gunung berapi aktif yang terletak di Jawa Tengah. Dengan puncak setinggi 3.428 meter, gunung ini adalah salah satu yang tertinggi di Jawa Tengah dan menawarkan jalur pendakian yang menantang.',
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) =>  PersonalDataFormPageslamet()),
                      );
                    },
