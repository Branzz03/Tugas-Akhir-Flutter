...
class TravelFormRegistrationPagesindoro extends StatefulWidget {
  const TravelFormRegistrationPagesindoro({super.key});

  @override
  _TravelFormRegistrationPagesindoroState createState() =>
      _TravelFormRegistrationPagesindoroState();
}

class _TravelFormRegistrationPagesindoroState
    extends State<TravelFormRegistrationPagesindoro> {
  ...
  // Daftar basecamp Gunung Sindoro
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) =>  PersonalDataFormPagesindoro()),
                      );
                    },
