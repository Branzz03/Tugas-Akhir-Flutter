...
class TravelFormRegistrationPagelawu extends StatefulWidget {
  const TravelFormRegistrationPagelawu({super.key});

  @override
  _TravelFormRegistrationPagelawuState createState() =>
      _TravelFormRegistrationPagelawuState();
}

class _TravelFormRegistrationPagelawuState
    extends State<TravelFormRegistrationPagelawu> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  Image.asset(
                    '../assets/lawu/lawu1.png',
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.cover,
                  ),
                  Image.asset(
                    '../assets/lawu/lawu2.png',
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.cover,
                  ),
                  Image.asset(
                    '../assets/lawu/lawu3.png',
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.cover,
                  ),
                ],
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) =>  PersonalDataFormPagelawu()),
                      );
                    },
