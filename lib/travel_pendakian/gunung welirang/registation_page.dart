...
class TravelFormRegistrationPagewelirang extends StatefulWidget {
  const TravelFormRegistrationPagewelirang({super.key});

  @override
  _TravelFormRegistrationPagewelirangState createState() =>
      _TravelFormRegistrationPagewelirangState();
}

class _TravelFormRegistrationPagewelirangState
    extends State<TravelFormRegistrationPagewelirang> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  Image.asset(
                    '../assets/welirang/welirang1.png',
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.cover,
                  ),
                  Image.asset(
                    '../assets/welirang/welirang2.png',
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.cover,
                  ),
                  Image.asset(
                    '../assets/welirang/welirang3.png',
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.cover,
                  ),
                ],
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'Gunung Welirang adalah gunung api yang terletak di wilayah Mojokerto, Jawa Timur. '
                    'Gunung ini terkenal dengan pemandangan indah dan suhu dinginnya, serta pemandian air panas alami di sekitar area. '
                    'Terdapat beberapa jalur pendakian yang dapat diambil untuk menuju puncak gunung ini.',
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) =>  PersonalDataFormPagewelirang()),
                      );
                    },
