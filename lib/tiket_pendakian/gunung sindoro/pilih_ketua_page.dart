...
class PilihKetuaPagesindoro extends StatefulWidget {
  final List<String> teamMembers;

  const PilihKetuaPagesindoro({Key? key, required this.teamMembers}) : super(key: key);

  @override
  _PilihKetuaPageStatesindoro createState() => _PilihKetuaPageStatesindoro();
}

class _PilihKetuaPageStatesindoro extends State<PilihKetuaPagesindoro> {
  ...
  void _lanjutkanKePembayaran() {
    if (_selectedKetua != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PembayaranPagesindoro(),
        ),
      );
    }
  }
