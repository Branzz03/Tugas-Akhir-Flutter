...
class RegistrationPagesindoro extends StatefulWidget {
  const RegistrationPagesindoro({super.key});

  @override
  State<RegistrationPagesindoro> createState() => _RegistrationPageStatesindoro();
}

class _RegistrationPageStatesindoro extends State<RegistrationPagesindoro> {
                ...
                onPressed: isChecked
                    ? () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FormRegistrationPagesindoro(),
                          ),
                        );
                      }
