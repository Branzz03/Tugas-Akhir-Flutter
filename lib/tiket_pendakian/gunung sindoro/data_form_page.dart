...
class DataFormPagesindoro extends StatefulWidget {
  final Map<String, String?> initialData;

  const DataFormPagesindoro({super.key, required this.initialData});

  @override
  _DataFormPageStatesindoro createState() => _DataFormPageStatesindoro();
}

class _DataFormPageStatesindoro extends State<DataFormPagesindoro> {
