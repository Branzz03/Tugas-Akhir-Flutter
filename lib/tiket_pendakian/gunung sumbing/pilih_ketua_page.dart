...
class PilihKetuaPagesumbing extends StatefulWidget {
  final List<String> teamMembers;

  const PilihKetuaPagesumbing({Key? key, required this.teamMembers}) : super(key: key);

  @override
  _PilihKetuaPageStatesumbing createState() => _PilihKetuaPageStatesumbing();
}

class _PilihKetuaPageStatesumbing extends State<PilihKetuaPagesumbing> {
  ...
  void _lanjutkanKePembayaran() {
    if (_selectedKetua != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PembayaranPagesumbing(),
        ),
      );
    }
  }
