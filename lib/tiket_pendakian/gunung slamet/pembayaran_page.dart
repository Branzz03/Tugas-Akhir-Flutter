...
class PembayaranPageslamet extends StatefulWidget {
  @override
  _PembayaranPageslametState createState() => _PembayaranPageslametState();
}

class _PembayaranPageslametState extends State<PembayaranPageslamet> {
            ...
            child: Column(
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.network(
                    '../assets/slamet/slamet2.png', // Ganti dengan URL gambar yang sesuai
                    height: 200,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      Text(
                        'Registrasi Pendakian Gn. Slamet',
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                      ...
                      Text('Basecamp Naik : Basecamp Bambangan'),
                      Text('Basecamp Turun : Basecamp Bambangan'),
