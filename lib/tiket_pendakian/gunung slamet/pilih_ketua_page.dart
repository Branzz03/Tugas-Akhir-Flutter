...
class PilihKetuaPageslamet extends StatefulWidget {
  final List<String> teamMembers;

  const PilihKetuaPageslamet({Key? key, required this.teamMembers}) : super(key: key);

  @override
  _PilihKetuaPageStateslamet createState() => _PilihKetuaPageStateslamet();
}

class _PilihKetuaPageStateslamet extends State<PilihKetuaPageslamet> {
  ...
  void _lanjutkanKePembayaran() {
    if (_selectedKetua != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PembayaranPageslamet(),
        ),
      );
    }
  }
