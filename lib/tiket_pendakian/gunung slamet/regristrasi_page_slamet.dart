...
class RegistrationPageslamet extends StatefulWidget {
  const RegistrationPageslamet({super.key});

  @override
  State<RegistrationPageslamet> createState() => _RegistrationPageStateslamet();
}

class _RegistrationPageStateslamet extends State<RegistrationPageslamet> {
                ...
                onPressed: isChecked
                    ? () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FormRegistrationPageslamet(),
                          ),
                        );
                      }
