...
class DataFormPagesemeru extends StatefulWidget {
  final Map<String, String?> initialData;

  const DataFormPagesemeru({super.key, required this.initialData});

  @override
  _DataFormPageStatesemeru createState() => _DataFormPageStatesemeru();
}

class _DataFormPageStatesemeru extends State<DataFormPagesemeru> {
