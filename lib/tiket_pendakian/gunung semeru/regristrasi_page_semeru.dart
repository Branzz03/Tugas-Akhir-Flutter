...
class RegistrationPagesemeru extends StatefulWidget {
  const RegistrationPagesemeru({super.key});

  @override
  State<RegistrationPagesemeru> createState() => _RegistrationPageStatesemeru();
}

class _RegistrationPageStatesemeru extends State<RegistrationPagesemeru> {
                ...
                onPressed: isChecked
                    ? () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FormRegistrationPagesemeru(),
                          ),
                        );
                      }
