...
class DataFormPagewelirang extends StatefulWidget {
  final Map<String, String?> initialData;

  const DataFormPagewelirang({super.key, required this.initialData});

  @override
  _DataFormPageStatewelirang createState() => _DataFormPageStatewelirang();
}

class _DataFormPageStatewelirang extends State<DataFormPagewelirang> {
