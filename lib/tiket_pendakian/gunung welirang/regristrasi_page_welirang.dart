...
class RegistrationPagewelirang extends StatefulWidget {
  const RegistrationPagewelirang({super.key});

  @override
  State<RegistrationPagewelirang> createState() => _RegistrationPageStatewelirang();
}

class _RegistrationPageStatewelirang extends State<RegistrationPagewelirang> {
                ...
                onPressed: isChecked
                    ? () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FormRegistrationPagewelirang(),
                          ),
                        );
                      }
