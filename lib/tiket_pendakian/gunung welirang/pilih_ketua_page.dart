...
class PilihKetuaPagewelirang extends StatefulWidget {
  final List<String> teamMembers;

  const PilihKetuaPagewelirang({Key? key, required this.teamMembers}) : super(key: key);

  @override
  _PilihKetuaPageStatewelirang createState() => _PilihKetuaPageStatewelirang();
}

class _PilihKetuaPageStatewelirang extends State<PilihKetuaPagewelirang> {
  ...
  void _lanjutkanKePembayaran() {
    if (_selectedKetua != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PembayaranPagewelirang(),
        ),
      );
    }
  }
