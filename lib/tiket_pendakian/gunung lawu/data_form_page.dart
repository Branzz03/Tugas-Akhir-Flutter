...
class DataFormPagelawu extends StatefulWidget {
  final Map<String, String?> initialData;

  const DataFormPagelawu({super.key, required this.initialData});

  @override
  _DataFormPageStatelawu createState() => _DataFormPageStatelawu();
}

class _DataFormPageStatelawu extends State<DataFormPagelawu> {
