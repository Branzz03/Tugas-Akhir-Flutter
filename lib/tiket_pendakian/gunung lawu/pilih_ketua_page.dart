...
class PilihKetuaPagelawu extends StatefulWidget {
  final List<String> teamMembers;

  const PilihKetuaPagelawu({Key? key, required this.teamMembers}) : super(key: key);

  @override
  _PilihKetuaPageStatelawu createState() => _PilihKetuaPageStatelawu();
}

class _PilihKetuaPageStatelawu extends State<PilihKetuaPagelawu> {
  ...
  void _lanjutkanKePembayaran() {
    if (_selectedKetua != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PembayaranPagelawu(),
        ),
      );
    }
  }
