...
class RegistrationPagelawu extends StatefulWidget {
  const RegistrationPagelawu({super.key});

  @override
  State<RegistrationPagelawu> createState() => _RegistrationPageStatelawu();
}

class _RegistrationPageStatelawu extends State<RegistrationPagelawu> {
                ...
                onPressed: isChecked
                    ? () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FormRegistrationPagelawu(),
                          ),
                        );
                      }
