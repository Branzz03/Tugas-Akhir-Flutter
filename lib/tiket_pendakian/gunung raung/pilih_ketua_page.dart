...
class PilihKetuaPagemerbabu extends StatefulWidget {
  final List<String> teamMembers;

  const PilihKetuaPagemerbabu({Key? key, required this.teamMembers}) : super(key: key);

  @override
  _PilihKetuaPageStatemerbabu createState() => _PilihKetuaPageStatemerbabu();
}

class _PilihKetuaPageStatemerbabu extends State<PilihKetuaPagemerbabu> {
  ...
  void _lanjutkanKePembayaran() {
    if (_selectedKetua != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PembayaranPagemerbabu(),
        ),
      );
    }
  }
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor: _selectedKetua != null ? Colors.blueAccent : Colors.blueAccent,
