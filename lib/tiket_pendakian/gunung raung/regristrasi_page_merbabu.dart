...
class RegistrationPagemerbabu extends StatefulWidget {
  const RegistrationPagemerbabu({super.key});

  @override
  State<RegistrationPagemerbabu> createState() => _RegistrationPageStatemerbabu();
}

class _RegistrationPageStatemerbabu extends State<RegistrationPagemerbabu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Peraturan Mendaki', style: TextStyle(color: Colors.white),),
                ...
                onPressed: isChecked
                    ? () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FormRegistrationPagemerbabu(),
                          ),
                        );
                      }
