...
class FormRegistrationPagearjuno extends StatefulWidget {
  const FormRegistrationPagearjuno({super.key});

  @override
  _FormRegistrationPageStatesindoro createState() => _FormRegistrationPageStatesindoro();
}

class _FormRegistrationPageStatesindoro extends State<FormRegistrationPagearjuno> {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DataEntryPagearjuno(jumlahRombongan: _jumlahRombongan),
                        ),
                      );
                    },
