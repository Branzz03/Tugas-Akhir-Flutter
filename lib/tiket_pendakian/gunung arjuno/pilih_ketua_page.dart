...
class PilihKetuaPagearjuno extends StatefulWidget {
  final List<String> teamMembers;

  const PilihKetuaPagearjuno({Key? key, required this.teamMembers}) : super(key: key);

  @override
  _PilihKetuaPageStatearjuno createState() => _PilihKetuaPageStatearjuno();
}

class _PilihKetuaPageStatearjuno extends State<PilihKetuaPagearjuno> {
  ...
  void _lanjutkanKePembayaran() {
    if (_selectedKetua != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PembayaranPagearjuno(),
        ),
      );
    }
  }
