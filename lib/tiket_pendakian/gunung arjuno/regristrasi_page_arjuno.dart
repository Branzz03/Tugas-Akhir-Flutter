...
class RegistrationPagearjuno extends StatefulWidget {
  const RegistrationPagearjuno({super.key});

  @override
  State<RegistrationPagearjuno> createState() => _RegistrationPageStatearjuno();
}

class _RegistrationPageStatearjuno extends State<RegistrationPagearjuno> {
                ...
                onPressed: isChecked
                    ? () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FormRegistrationPagearjuno(),
                          ),
                        );
                      }
