...
class PembayaranPagearjuno extends StatefulWidget {
  @override
  _PembayaranPagearjunoState createState() => _PembayaranPagearjunoState();
}
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      Text(
                        'Registrasi Pendakian Gn. Arjuno',
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                      ...
                      Text('Basecamp Naik : Basecamp Sumber Brantas'),
                      Text('Basecamp Turun : Basecamp Sumber Brantas'),
