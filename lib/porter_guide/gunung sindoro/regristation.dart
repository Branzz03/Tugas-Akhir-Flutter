...
class PorterRegristationsindoro extends StatefulWidget {
  const PorterRegristationsindoro({super.key});

  @override
  _PorterRegistrationsindoroState createState() => _PorterRegistrationsindoroState();
}

class _PorterRegistrationsindoroState extends State<PorterRegristationsindoro> {
                          ...
                          onPressed: () {
                            ...
                            if (selectedType == 'Porter') {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => PorterDetailPagesindoro(
                                    name: name,
                                  ),
                                ),
                              );
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => GuideDetailPagesindoro(
                                    name: name,
                                  ),
                                ),
                              );
