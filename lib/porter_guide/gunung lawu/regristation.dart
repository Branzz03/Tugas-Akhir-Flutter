...
class PorterRegristationlawu extends StatefulWidget {
  const PorterRegristationlawu({super.key});

  @override
  _PorterRegistrationlawuState createState() => _PorterRegistrationlawuState();
}

class _PorterRegistrationlawuState extends State<PorterRegristationlawu> {
                          ...
                          onPressed: () {
                            ...
                            if (selectedType == 'Porter') {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => PorterDetailPagelawu(
                                    name: name,
                                  ),
                                ),
                              );
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => GuideDetailPagelawu(
                                    name: name,
                                  ),
                                ),
                              );
