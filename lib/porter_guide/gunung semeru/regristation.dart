...
class PorterRegristationsemeru extends StatefulWidget {
  const PorterRegristationsemeru({super.key});

  @override
  _PorterRegistrationsemeruState createState() => _PorterRegistrationsemeruState();
}

class _PorterRegistrationsemeruState extends State<PorterRegristationsemeru> {
                          ...
                          onPressed: () {
                            ...
                            if (selectedType == 'Porter') {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => PorterDetailPagesemeru(
                                    name: name,
                                  ),
                                ),
                              );
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => GuideDetailPagesemeru(
                                    name: name,
                                  ),
                                ),
                              );
