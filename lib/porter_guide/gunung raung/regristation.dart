...
class PorterRegristationraung extends StatefulWidget {
  const PorterRegristationraung({super.key});

  @override
  _PorterRegistrationraungState createState() => _PorterRegistrationraungState();
}

class _PorterRegistrationraungState extends State<PorterRegristationraung> {
                          ...
                          onPressed: () {
                            ...
                            if (selectedType == 'Porter') {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => PorterDetailPageraung(
                                    name: name,
                                  ),
                                ),
                              );
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => GuideDetailPageraung(
                                    name: name,
                                  ),
                                ),
                              );
