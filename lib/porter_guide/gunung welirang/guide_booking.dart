...
class GuideDetailPagewelirang extends StatelessWidget {
  final String name;

  const GuideDetailPagewelirang({Key? key, required this.name}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, dynamic> guideDetails = {
     'Siti Aminah': {
        ...
        'city': 'Jakarta',
        'gender': 'Perempuan',
        'image': '../assets/porter/guide2.png',
        'experience': 10,
        'mountains': ['Gunung Rinjani', 'Gunung Semeru', 'Gunung Bromo']
      },
      'Rina Marlina': {
        'age': 27,
        'city': 'Bandung',
        'gender': 'Perempuan',
        'image': '../assets/porter/guide1.png',
        'experience': 6,
        'mountains': ['Gunung Gede', 'Gunung Pangrango', 'Gunung Ciremai']
      },
      'Teguh Harianto': {
        'age': 30,
        'city': 'Semarang',
        'gender': 'Laki-laki',
        'image': '../assets/porter/guide3.png',
        'experience': 8,
        'mountains': ['Gunung Prau', 'Gunung Slamet', 'Gunung Arjuno']
      },
    };

    final guide = guideDetails[name]!;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Usia: ${guide['age']} tahun | ${guide['city']}',
                                  style: const TextStyle(
                                      fontSize: 16, color: Colors.black),
                                ),
                                const SizedBox(height: 4),
                                Text(
                                  'Jenis Kelamin: ${guide['gender']}',
                                  style: const TextStyle(
                                      fontSize: 16, color: Colors.black),
                                ),
                                const SizedBox(height: 8),
                                Text(
                                  'Pengalaman: ${guide['experience']} tahun',
                                  style: const TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.green,
                      ...
                      const SizedBox(height: 8),
                      ...guide['mountains'].map<Widget>((mountain) {
                        return Padding(
