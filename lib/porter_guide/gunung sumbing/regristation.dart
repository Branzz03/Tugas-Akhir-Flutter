...
class PorterRegristationsumbing extends StatefulWidget {
  const PorterRegristationsumbing({super.key});

  @override
  _PorterRegistrationsumbingState createState() => _PorterRegistrationsumbingState();
}

class _PorterRegistrationsumbingState extends State<PorterRegristationsumbing> {
                          ...
                          onPressed: () {
                            ...
                            if (selectedType == 'Porter') {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => PorterDetailPagesumbing(
                                    name: name,
                                  ),
                                ),
                              );
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => GuideDetailPagesumbing(
                                    name: name,
                                  ),
                                ),
                              );
