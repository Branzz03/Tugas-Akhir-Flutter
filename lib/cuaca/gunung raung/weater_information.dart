...
class WeatherInformationraung extends StatelessWidget {
  const WeatherInformationraung({Key? key}) : super(key: key);
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: List.generate(24, (index) {
                        ...
                        final windSpeed = '${(8 + index % 3).toStringAsFixed(1)} km/h';
                        final temp = '${(5 + index % 4).toStringAsFixed(1)}°C';
