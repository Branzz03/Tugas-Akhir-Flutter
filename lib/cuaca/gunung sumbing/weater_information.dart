...
class WeatherInformationsumbing extends StatelessWidget {
  const WeatherInformationsumbing({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Informasi Cuaca: Gunung Sumbing',
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: List.generate(24, (index) {
                        ...
                        final windSpeed = '${(5 + index % 4).toStringAsFixed(1)} km/h';
                        final temp = '${(9 + index % 5).toStringAsFixed(1)}°C';
