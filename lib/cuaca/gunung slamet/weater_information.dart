...
class WeatherInformationslamet extends StatelessWidget {
  const WeatherInformationslamet({Key? key}) : super(key: key);
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: List.generate(24, (index) {
                        ...
                        final windSpeed = '${(4 + index % 4).toStringAsFixed(1)} km/h';
                        final temp = '${(9 + index % 4).toStringAsFixed(1)}°C';
