...
class WeatherInformationwelirang extends StatelessWidget {
  const WeatherInformationwelirang({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Informasi Cuaca: Gunung Welirang',
          style: TextStyle(color: Colors.white),
        ),
        centerTitle: true,
        elevation: 4,
      ),
      backgroundColor: const Color(0xFFE3F2FD), // Warna latar belakang biru terang
      body: Column(
        children: [
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: List.generate(24, (index) {
                        ...
                        final windSpeed = '${(5 + index % 5).toStringAsFixed(1)} km/h';
                        final temp = '${(15 + index % 6).toStringAsFixed(1)}°C';
                        final icon = index >= 6 && index <= 18 ? Icons.wb_cloudy : Icons.nightlight_round;
