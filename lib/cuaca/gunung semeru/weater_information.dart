...
class WeatherInformationsemeru extends StatelessWidget {
  const WeatherInformationsemeru({Key? key}) : super(key: key);
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: List.generate(24, (index) {
                        ...
                        final windSpeed = '${(10 + index % 4).toStringAsFixed(1)} km/h';
                        final temp = '${(3 + index % 4).toStringAsFixed(1)}°C';
