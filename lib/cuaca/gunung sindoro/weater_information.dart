...
class WeatherInformationsindoro extends StatelessWidget {
  const WeatherInformationsindoro({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Informasi Cuaca: Gunung Sindoro',
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: List.generate(24, (index) {
                        ...
                        final windSpeed = '${(5 + index % 3).toStringAsFixed(1)} km/h';
                        final temp = '${(8 + index % 5).toStringAsFixed(1)}°C';
                        final icon = index >= 6 && index <= 18 ? Icons.cloud : Icons.nightlight_round;
