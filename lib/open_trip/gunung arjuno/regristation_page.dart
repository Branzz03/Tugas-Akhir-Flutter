...
class RegistrationPagearjuno extends StatelessWidget {
  final String tripName;

  const RegistrationPagearjuno({Key? key, required this.tripName}) : super(key: key);
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            Image.asset(
              '../assets/arjuno/arjuno1.png', // Tambahkan gambar Gunung Arjuno di folder assets
              height: 200,
              fit: BoxFit.cover,
            ),
            const SizedBox(height: 16),
